...
note_demo_raw = [
    ...
    (1, 'Educație Antreprenorială', 10, 1, '2025-06-13'),
    (3, 'Educație Antreprenorială', 9, 1, '2025-05-28'),
    (1, 'Educație Antreprenorială', 10, 1, '2025-01-15'),
    (1, 'Educație Antreprenorială', 10, 1, '2025-02-14'),
    (1, 'Educație Fizică', 10, 1, '2025-05-29'),
    (1, 'Educație Fizică', 10, 1, '2025-04-07'),
    (1, 'Educație Fizică', 10, 1, '2025-02-03'),
    (1, 'Educație Fizică', 10, 1, '2024-12-09'),
    (1, 'Educație Fizică', 10, 1, '2024-10-17'),
    (1, 'Educație Muzicală', 10, 1, '2025-05-05'),
    (1, 'Educație Muzicală', 10, 1, '2025-05-27'),
    (1, 'Educație Muzicală', 10, 1, '2025-01-21'),
    (1, 'Educație Muzicală', 10, 1, '2024-12-10'),
    (1, 'Fizică', 10, 1, '2025-06-13'),
    (1, 'Fizică', 10, 1, '2025-05-28'),
    (1, 'Fizică', 10, 1, '2025-05-21'),
    ...
    (1, 'Informatică', 9, 1, '2025-05-05'),
    (1, 'Informatică', 9, 1, '2025-05-27'),
    (1, 'Informatică', 8, 1, '2025-06-17'),
    (1, 'Informatică', 9, 1, '2024-11-14'),
    (1, 'Istorie',10,1,'2025-06-16'),
    (1, 'Istorie',9,1,'2025-05-23'),
    (1, 'Istorie',10,1,'2025-01-10'),
    (1, 'Istorie',10,1,'2024-11-15'),
    (1, 'Psihologie',10, 1,'2025-02-04'),
    (1, 'Psihologie',10, 1,'2024-12-10'),
    (1, 'Limba Engleză', 10,1,'2025-05-26'),
    ...
    (1, 'Limba Franceză', 9,1,'2025-05-27'),
    (1, 'Limba Română', 8,1,'2025-05-20'),
    (1, 'Limba Română', 9,1,'2025-06-02'),
    (1, 'Limba Română', 10,1,'2025-03-03'),
    (1, 'Limba Română', 10,1,'2025-01-27'),
    (1, 'Limba Română', 7,1,'2024-12-02'),
    (1, 'Limba Română', 8,1,'2024-10-15'),
    (1, 'Matematică',8,1,'2024-12-17'),
    (1, 'Matematică',7,1,'2025-05-04'),
    (1, 'Matematică',8,1,'2025-04-29'),
    (1, 'Matematică',9,1,'2025-06-03'),
    (1, 'Matematică',7,1,'2025-11-19'),
    (1, 'Matematică',9,1,'2025-10-15'),
    (1, 'Purtare',10,1,'2025-04-17'),
    ...
    (1, 'Tehnologia Informației Și A Comunicațiilor',10,1,'2025-05-27'),
